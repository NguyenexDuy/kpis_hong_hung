...
class MidwifeEvaluatesTheStaffWithoutATeamLeaderPage extends StatefulWidget {
  const MidwifeEvaluatesTheStaffWithoutATeamLeaderPage({super.key});

  @override
  State<MidwifeEvaluatesTheStaffWithoutATeamLeaderPage> createState() =>
      _MidwifeEvaluatesTheStaffWithoutATeamLeaderPageState();
}

class _MidwifeEvaluatesTheStaffWithoutATeamLeaderPageState
    extends State<MidwifeEvaluatesTheStaffWithoutATeamLeaderPage> {
  ...
  Future<void> _onPressed({
    ...
    if (selected != null) {
      setState(() {
        ...
        futureMethod =
            ManagerRepo().groupAssessment(_selectedMonth!, _selectedYear!);
      });
      setState(() {
        futureMethod =
            ManagerRepo().groupAssessment(_selectedMonth!, _selectedYear!);
        ...
        child: Column(
          children: [
            ...
            _selected == null
                ...
                : Text(
                    "Kết quả điều dưỡng/KTY/Hộ sinh trưởng khoa đánh giá các nhân viên không có trưởng nhóm  ${DateFormat().add_yM().format(_selected!)}"),
            futureMethod == null
                ? Column(
                    children: [
                      const Padding(
